...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { fornecedor_id: @produto.fornecedor_id, nome: @produto.nome, preco: @produto.preco }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { fornecedor_id: @produto.fornecedor_id, nome: @produto.nome, preco: @produto.preco }
    assert_redirected_to produto_path(assigns(:produto))
  end
